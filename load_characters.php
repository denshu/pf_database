<?php
	...
	echo '<div class="row placeholders characterModule">
	...
	// Sorting method
	echo '<div class="form-group"><label for="sort-by">Sort By</label><select class="form-control" id="sort-by">
								<option>name</option>
  	...
  	echo '<button type="button" class="btn btn-default btn-lg" id="search-button">
		  <span class="glyphicon glyphicon-search" aria-hidden="true"></span> Search </button>
		    </div></div></div></div></div></div>';


    // Creating the grid of characters
    echo '<div id="character-grid-container">
